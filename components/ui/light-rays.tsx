...
import { HTMLAttributes, Ref, useEffect, useState, type CSSProperties } from "react";
...
export function LightRays( props: LightRaysProps ) {
  const { className, style, count = 7, color = "rgba(160, 210, 255, 0.2)", blur = 36, speed = 14, length = "70vh", ref, ...rest } = props;
